...
<body>
	...
	<div class="section">
		<div class="container">
			<h3>Data Produk</h3>
			<div class="box">
				<a href="tambah-data-produk.php" class="btn">Tambah Data Produk</a>
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo ($row['product_status'] == 0)? 'Tidak Aktif' : 'Aktif';?>
							</td>

							</td>
							<td><a href="edit-produk.php?id=<?php echo $row['product_id']?>">Edit</a> || <a href="hapus-produk.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Hapus?')">Hapus</a></td>
						</tr>
						<?php 
						 }}else{ ?>
						 	<tr>
						 		<td colspan="8">Tida Ada Data Produk</td>
						 	</tr>
